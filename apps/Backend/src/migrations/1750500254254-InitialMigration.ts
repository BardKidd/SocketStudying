...
export class InitialMigration1750500254254 implements MigrationInterface {
    name = 'InitialMigration1750500254254'
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`post\` DROP COLUMN \`title\``);
        await queryRunner.query(`ALTER TABLE \`post\` ADD \`title\` varchar(255) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`post\` ADD CONSTRAINT \`FK_5c1cf55c308037b5aca1038a131\` FOREIGN KEY (\`userId\`) REFERENCES \`mygodb\`.\`user\`(\`id\`) ON DELETE CASCADE ON UPDATE NO ACTION`);
    }
